...
{
$sql=mysqli_query($con,"SELECT Password FROM  tblsubadmin where Password='".md5($_POST['password'])."' && UserName='".$_SESSION['subalogin']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($con,"update tblsubadmin set Password='".md5($_POST['newpassword'])."' where UserName='".$_SESSION['subalogin']."'");
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Sub-Admin Change Password</h3>
							</div>
