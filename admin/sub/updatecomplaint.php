...
$query=mysqli_query($con,"insert into tblsubadminremark(ComplainNumber,ComplainStatus,ComplainRemark,RemarkBy) values('$complaintnumber','$status','$remark','$sadminid')");
