    ...
    if(isset($_POST["recover"])){
        ...
        if(mysqli_num_rows($sql) <= 0){
           ...
           <?php
            ...
            $mail->Body='To reset your password clickk <a href="https://adypugrs.misotech.in/login-system-main/reset_psw.php?token='.$token.'">here </a>. </br>Reset your password in a day.';
            if(!$mail->send()){
                ?>
                    <script>
