...
<input type="password" class="form-control unicase-form-control text-input" placeholder="Confirm Password" id="confirmpassword" name="confirmpassword" required > -->
		                      ...
		                      <div class="modal-footer">
		                          ...
		                          <button class="btn btn-theme" type="submit" name="recover" onclick="return valid();">Recover</button>
		                      </div>
		                  </div>
		              </div>
		          </div>
...
<!-- Footer --><center>
        <footer>
            <div class="row">
                <div class="col-lg-12">
                    <p><strong style="color: #333;">Copyright &copy; Team Grievance Redressal System 2024</strong></p>
