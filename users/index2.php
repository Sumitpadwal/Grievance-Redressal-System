...
{
$ret=mysqli_query($con,"SELECT * FROM trail3 WHERE userEmail='".$_POST['username']."' and password='".md5($_POST['password'])."'");
...
$errormsg="Invalid username or passworrd";
$extra="login.php";
...
$query=mysqli_query($con,"SELECT * FROM trail3 WHERE userEmail='$email' and contactNo='$contact'");
$num=mysqli_fetch_array($query);
if($num>0)
{
mysqli_query($con,"update trail3 set password='$password' WHERE userEmail='$email' and contactNo='$contact' ");
...
<html lang="en">
  <head>
    ...
    <title>Grievance Redressal System | User Login</title>
...
return true;
  ...
  <body>
      ...
      *********************************************************************************************************************************************************** -->
	  ...
	  <div id="login-page">
	  	<div class="container">
	  		<h3 align="center" style="color:#fff"><a href="../index.html" style="color:#fff">NUTAN MAHARASHTRA INSTITUTE OF ENGINEERING & TECHNOLOGY, PUNE</a></h3>
	<hr />
...
<input type="password" class="form-control unicase-form-control text-input" placeholder="Confirm Password" id="confirmpassword" name="confirmpassword" required >
    ...
    <script>
        $.backstretch("assets/img/lgb.jpg", {speed: 500});
    </script>
...
<!-- Footer --><center>
        <footer>
            <div class="row">
                <div class="col-lg-12">
                    <p>Copyright &copy;  Team NUTAN MAHARASHTRA INSTITUTE OF ENGINEERING & TECHNOLOGY, PUNE 2024</p>
                </div>
            </div>
            <!-- /.row -->
        </footer>
